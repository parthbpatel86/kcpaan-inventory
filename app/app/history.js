...
const styles = StyleSheet.create({
  ...
  summaryLbl: { fontSize: 18, color: colors.textMuted, marginTop: 2 },
  ...
  scopeTxt: { fontSize: 18, fontWeight: '700', color: colors.textMuted },
  ...
  rowTotal: { fontSize: 20, fontWeight: '800', color: colors.text },
  strike: { textDecorationLine: 'line-through', color: colors.textMuted },
  rowMeta: { fontSize: 18, color: colors.textMuted, marginTop: 2 },
  voidTag: { color: colors.order, fontWeight: '800', fontSize: 18 },
  ...
  sheetMeta: { fontSize: 18, color: colors.textMuted, marginTop: 2, marginBottom: spacing.md },
  itemList: { gap: spacing.sm, marginBottom: spacing.md },
  itemRow: { flexDirection: 'row', alignItems: 'center' },
  itemName: { flex: 1, fontSize: 19, color: colors.text, fontWeight: '600' },
  itemQty: { fontSize: 18, color: colors.textMuted, marginRight: spacing.md },
  itemLine: { fontSize: 19, fontWeight: '700', color: colors.text, minWidth: 60, textAlign: 'right' },
  ...
  totLbl: { fontSize: 18, color: colors.textMuted },
  totVal: { fontSize: 18, color: colors.text, fontWeight: '600' },
  totLblBig: { fontSize: 20, color: colors.text, fontWeight: '800' },
  ...
  voidBtnTxt: { color: colors.order, fontWeight: '800', fontSize: 19 },
