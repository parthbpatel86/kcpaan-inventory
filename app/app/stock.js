...
const styles = StyleSheet.create({
  ...
  qsTitle: { fontSize: 20, fontWeight: '900', color: colors.text, marginBottom: 4 },
  qsRow: { flexDirection: 'row', gap: spacing.md },
  qsLabel: { fontSize: 18, fontWeight: '800', color: colors.textMuted, marginTop: spacing.sm },
  qsInput: {
  ...
  qsPreview: { fontSize: 18, fontWeight: '700', color: colors.primary, textAlign: 'center', marginTop: 4 },
  ...
  back: { color: colors.text, fontSize: 20, fontWeight: '600' },
  headerTitle: { color: colors.text, fontSize: 20, fontWeight: '800' },
  addNew: { color: colors.text, fontSize: 20, fontWeight: '800' },
  ...
  statLabel: { fontSize: 18, color: colors.textMuted, marginTop: 2 },
  ...
  chipTxt: { fontSize: 18, fontWeight: '700', color: colors.textMuted },
  chipTxtActive: { color: colors.white },

  searchWrap: { padding: spacing.md, paddingBottom: spacing.sm },
  search: { backgroundColor: colors.surface, borderRadius: radius.md, paddingHorizontal: spacing.md, paddingVertical: spacing.sm, fontSize: 19, borderWidth: 1, borderColor: colors.border, color: colors.text },

  errorBar: { backgroundColor: '#FDECEA', padding: spacing.sm, paddingHorizontal: spacing.lg },
  errorTxt: { color: colors.order, fontSize: 18 },
  ...
  rowName: { fontSize: 19, fontWeight: '700', color: colors.text },
  rowCat: { fontSize: 18, color: colors.textMuted, marginTop: 2 },
  ...
  stockChipLabel: { fontSize: 18, color: colors.textMuted, fontWeight: '700' },
  stockChipVal: { fontSize: 20, fontWeight: '800', color: colors.text },
  ...
  quickHint: { fontSize: 18, color: colors.textMuted, flex: 1 },
  ...
  quickBtnTxt: { color: colors.primary, fontWeight: '800', fontSize: 18 },
  ...
  section: { fontSize: 18, fontWeight: '800', color: colors.primary, textTransform: 'uppercase', letterSpacing: 0.5, marginTop: spacing.lg, marginBottom: spacing.sm },
  fieldRow: { flexDirection: 'row', gap: spacing.md },
  fieldLabel: { fontSize: 18, color: colors.textMuted, marginBottom: 4, fontWeight: '600' },
  input: { backgroundColor: colors.surfaceAlt, borderRadius: radius.sm, paddingHorizontal: spacing.md, paddingVertical: spacing.sm, fontSize: 20, color: colors.text, borderWidth: 1, borderColor: colors.border },
  ...
  primaryBtnTxt: { color: colors.white, fontWeight: '800', fontSize: 20 },
  ...
  currentStockTxt: { fontSize: 19, color: colors.text },

  adjustRow: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm, marginBottom: spacing.sm },
  adjustLabel: { width: 90, fontSize: 18, color: colors.text, fontWeight: '600' },
  adjustInput: { flex: 1, backgroundColor: colors.surfaceAlt, borderRadius: radius.sm, paddingHorizontal: spacing.md, paddingVertical: spacing.sm, fontSize: 20, color: colors.text, borderWidth: 1, borderColor: colors.border },
  ...
  moveInput: { flex: 1, backgroundColor: colors.surfaceAlt, borderRadius: radius.sm, paddingHorizontal: spacing.md, paddingVertical: spacing.sm, fontSize: 20, color: colors.text, borderWidth: 1, borderColor: colors.border },
  ...
  archiveTxt: { color: colors.order, fontWeight: '700', fontSize: 19 },
  closeBtn: { alignItems: 'center', paddingVertical: spacing.md, marginTop: spacing.sm },
  closeTxt: { color: colors.textMuted, fontSize: 20, fontWeight: '600' },
});
