...
const styles = StyleSheet.create({
  ...
  back: { color: colors.white, fontSize: 20, fontWeight: '600' },
  ...
  rangeTxt: { fontSize: 18, fontWeight: '700', color: colors.textMuted },
  ...
  headLbl: { fontSize: 18, color: colors.primaryLight, marginTop: 2 },
  discNote: { fontSize: 18, color: colors.accent, fontWeight: '600', textAlign: 'center' },
  ...
  barDay: { width: 44, fontSize: 18, color: colors.textMuted },
  ...
  barVal: { width: 50, textAlign: 'right', fontSize: 18, fontWeight: '700', color: colors.text },

  splitRow: { flexDirection: 'row', alignItems: 'center', marginBottom: spacing.sm },
  splitLabel: { flex: 1, fontSize: 19, color: colors.text, fontWeight: '600' },
  splitCount: { fontSize: 18, color: colors.textMuted, marginRight: spacing.md },
  splitTotal: { fontSize: 20, fontWeight: '800', color: colors.primary, minWidth: 70, textAlign: 'right' },

  topRow: { flexDirection: 'row', alignItems: 'center', marginBottom: spacing.sm, gap: spacing.sm },
  topRank: { width: 22, height: 22, borderRadius: 11, backgroundColor: colors.gold, color: colors.text, textAlign: 'center', lineHeight: 22, fontWeight: '800', fontSize: 18 },
  topName: { flex: 1, fontSize: 19, color: colors.text, fontWeight: '600' },
  topQty: { fontSize: 18, color: colors.textMuted, marginRight: spacing.sm },
  topRev: { fontSize: 19, fontWeight: '700', color: colors.primary, minWidth: 50, textAlign: 'right' },
});
