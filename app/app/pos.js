...
const styles = StyleSheet.create({
  ...
  offlineTxt: { color: colors.text, fontWeight: '700', fontSize: 13 },
  ...
  searchInput: { flex: 1, fontSize: 18, paddingVertical: spacing.md, paddingHorizontal: spacing.sm, color: colors.text },
  searchClear: { fontSize: 18, color: colors.textMuted, paddingHorizontal: spacing.sm },

  body: { flex: 1, flexDirection: 'row' },
  gridWrap: { flex: 1 },

  quickSection: { marginBottom: spacing.md },
  quickTitle: { fontSize: 16, fontWeight: '800', color: colors.text, marginBottom: spacing.sm },
  ...
  favName: { fontSize: 12, fontWeight: '700', color: colors.text, marginTop: 4 },
  favPrice: { fontSize: 15, fontWeight: '800', color: colors.primary },
  ...
  cardName: { fontSize: 15, fontWeight: '700', color: colors.text, marginTop: spacing.sm },
  cardPrice: { fontSize: 20, fontWeight: '900', color: colors.primary, marginTop: 2 },
  cardStock: { fontSize: 12, fontWeight: '700', color: colors.textMuted, marginTop: 2 },
  ...
  cardAddHintTxt: { fontSize: 13, color: colors.textMuted, fontWeight: '800' },
  ...
  cartCount: { color: colors.white, fontSize: 14, fontWeight: '700', opacity: 0.9 },
  ...
  reviewTxt: { color: colors.text, fontSize: 18, fontWeight: '900' },
  reviewGu: { color: colors.text, fontSize: 12, fontWeight: '700' },
});
