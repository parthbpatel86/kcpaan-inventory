...
const styles = StyleSheet.create({
  ...
  backBtnTxt: { color: colors.white, fontWeight: '800', fontSize: 16 },
  ...
  back: { color: colors.white, fontSize: 17, fontWeight: '700' },
  headerTitle: { color: colors.white, fontSize: 20, fontWeight: '800' },
  headerCount: { color: colors.white, fontSize: 18, fontWeight: '800' },
  ...
  lineTotal: { fontSize: 17, fontWeight: '800', color: colors.primary, minWidth: 72, textAlign: 'right' },
  ...
  totalLabel: { fontSize: 18, fontWeight: '700', color: colors.textMuted },
  totalValue: { fontSize: 34, fontWeight: '900', color: colors.text },
  strike: { fontSize: 15, color: colors.textLight, textDecorationLine: 'line-through' },
  discNote: { fontSize: 13, color: colors.accent, fontWeight: '700', textAlign: 'right' },
  ...
  discBtnTxt: { fontSize: 13, fontWeight: '700', color: colors.textMuted },
  ...
  payEn: { color: colors.white, fontSize: 18, fontWeight: '900', marginTop: 2 },
  payGu: { color: colors.white, fontSize: 14, fontWeight: '700', opacity: 0.95 },
  paySub: { color: colors.white, fontSize: 13, fontWeight: '800', marginTop: 2 },
  empHint: { marginTop: spacing.sm, fontSize: 13, fontWeight: '700', color: colors.gold, textAlign: 'center' },
  ...
  modalSub: { fontSize: 14, color: colors.textMuted, marginTop: 2 },
  ...
  modalPreview: { fontSize: 16, fontWeight: '800', color: colors.accent, marginTop: spacing.sm, textAlign: 'right' },
