...
| P1 | partial | M | premium | Staff accounts + roles/permissions | We only have a single shared PIN gating stock. Add a staff table with name + PIN + role; attach staff_id to sales and stock_movements; gate stock/reports by role. Lightweight for a 1-5 person shop. |
