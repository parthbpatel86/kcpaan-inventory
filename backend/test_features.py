...
check("max_discount_pct default 8", s.get("max_discount_pct") == "8")
...
check("rejection does NOT name the existing holder", "used_by" not in (dup.get_json() or {}), str(dup.get_json()))
